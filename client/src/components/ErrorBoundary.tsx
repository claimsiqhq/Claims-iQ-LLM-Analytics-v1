            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
              <div className="flex justify-center mb-6">
                <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center">
                  <WarningTriangle width={32} height={32} className="text-red-600" />
                </div>
              </div>
              <h1 className="text-2xl font-bold text-gray-900 text-center mb-2">Something Went Wrong</h1>
              <p className="text-center text-gray-600 mb-6">We encountered an unexpected error. Please try again.</p>
                  ...
                  <div className="bg-gray-50 rounded-lg p-3 border border-gray-200 font-mono text-gray-700 overflow-auto max-h-40">
                    ...
                    {this.state.errorInfo && (
                      <>
                        ...
                        <p className="text-red-700 break-words">{this.state.errorInfo.componentStack}</p>
                      </>
                    )}
                  </div>
                </details>
              ...
              <div className="flex flex-col gap-3">
                <Button
                  ...
                  className="w-full bg-brand-purple hover:bg-brand-deep-purple text-white font-medium py-3 rounded-lg flex items-center justify-center gap-2"
                >
